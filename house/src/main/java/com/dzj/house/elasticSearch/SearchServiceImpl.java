...
public class SearchServiceImpl implements SearchService {
	...
	public List<Long> query(SearchDto searchDto) {
		...
		SearchRequestBuilder requestBuilder =esClient.prepareSearch(INDEX_NAME).setTypes(INDEX_TYPE).setQuery(boolQuery)
